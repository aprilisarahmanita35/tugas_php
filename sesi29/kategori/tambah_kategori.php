            ...
            <form id="form_tambah" action="proses_tambah_kategori.php" method="post">
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="ukuran" value="Besar" id="ukuranBesar">
                        <label class="form-check-label" for="ukuranBesar">
                                Besar
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="ukuran" value="Kecil" id="ukuranKecil">
